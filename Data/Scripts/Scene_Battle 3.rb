...
class Scene_Battle
  ...
  def start_enemy_select
    @actor_arrow = Arrow_Actor.new(@spriteset.viewport2) #Kendrian 
    @actor_arrow.index = @actor_index #Kendrian
    @actor_arrow.help_window = @help_window #Kendrian 
    @actor_arrow.dispose #Kendrian
    @actor_arrow = nil #Kendrian
    # Make enemy arrow
