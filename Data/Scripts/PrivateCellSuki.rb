...
class PrivateCellDamselSuki < PrivateCellDamsel
    ...
    #To force a certain face, simply replace nil in proc with method(:face_facename). Supported facenames can be found in Face Library.
		...
		@dialogue['speak'] = []
		diaArray = []
		diaArray.push({'text'=>'Carol: If this is what happens when I win, we should fight more often!','proc'=>method(:face_shy)})
		diaArray.push({'text'=>'Suki1: You’re looking a little too happy about this…','proc'=>method(:face_annoyed),'talking'=>true})
		diaArray.push({'text'=>'Carol: C’mon, it’s no secret that I like doing this to cute girls.','proc'=>nil})
		diaArray.push({'text'=>'Carol: Although, maybe I should lose once in a while, if that means you’ll tie me up instead…','proc'=>nil})
		diaArray.push({'text'=>'Suki1: You’re a very straightforward girl.','proc'=>nil,'talking'=>true})
		diaArray.push({'text'=>'Carol: Uh-huh!','proc'=>nil})
		@dialogue['speak'].push(diaArray)
		
		diaArray = []
		diaArray.push({'text'=>'Carol: So, think you can wriggle out of this?','proc'=>nil})
		diaArray.push({'text'=>'Suki1: Nnh… I don’t know. I don’t think so…','proc'=>nil,'talking'=>true})
		diaArray.push({'text'=>'Carol: Hehe, the tables have turned on you now, huh?','proc'=>nil})
    diaArray.push({'text'=>'Carol: Maybe I should kidnap you and take you away somewhere…    ','proc'=>nil})
		diaArray.push({'text'=>'Suki1: Hey! I think you’re getting a little carried away!','proc'=>nil,'talking'=>true})
		diaArray.push({'text'=>'Carol: If you’re not careful, you’ll be the one who’s going to be getting carried away…','proc'=>nil})
		@dialogue['speak'].push(diaArray)
    ...
    @dialogue['maid'] = []
    diaArray = []
    diaArray.push({'text'=>'Carol: So, how about another go at being a maid?','proc'=>nil,'gag'=>'ungagged','blindfold'=>false})
    @dialogue['maid'][1] = diaArray
    ...
    @dialogue['maid'][2] = diaArray

    diaArray = []
    diaArray.push({'text'=>'Suki1: But we already have a maid?','proc'=>nil,'talking'=>true})
    diaArray.push({'text'=>'Carol: Damn, you\'re right. Maybe some other time.','proc'=>nil})
    diaArray.push({'text'=>'Suki1: (Whew, that was close!)','proc'=>method(:face_happy)})
    @dialogue['maid'][3] = diaArray
    ...
    diaArray.push({'text'=>'Suki1: I think that\'s a horrible idea!','proc'=>method(:face_annoyed),'talking'=>true})
    ...
    @dialogue['maid'][4] = diaArray
	end
	
end
$privateCellDamsels['suki'] = PrivateCellDamselSuki.new
